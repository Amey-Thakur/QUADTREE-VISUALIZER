...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/QUADTREE-VISUALIZER/issues) interface to formally record security-related findings.
...
## Implementation Context: TypeScript, Next.js & React
This project is implemented using TypeScript, Next.js, and React, as defined by the project’s technical scope.

-   **Execution Environment**: Execution occurs within standard Node.js environments.
-   **Scope Limitation**: This policy applies exclusively to the source code and academic materials contained within this repository and does not extend to the underlying web server engines, frameworks, or platform-level security guarantees.
