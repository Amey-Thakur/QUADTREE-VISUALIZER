/**
 * @file    sortedinsert.C
 * @brief   Inserts a node into a sorted linked list maintaining order.
 *
 * @author  Amey Thakur
 ...
 *
 * This program demonstrates sorted insertion into a linked list,
 * maintaining ascending order after each insertion.
 *
...
/**
 * @brief   Sorts a list using insertion sort.
 */
